...
20. stock batch quantity, unit cost, and expiry editing,
21. stock batch combining when added stock has the same expiry date and unit cost,
...
84. local order photo metadata and app-owned local photo file storage,
85. order detail photo groups for customer reference photos and final cake photos,
86. photo library import for order reference and final cake photos,
87. camera capture for order reference and final cake photos,
88. full-screen preview for saved order photos,
89. caption editing for saved order photos,
90. promotion of final cake photos into linked saved cake designs,
