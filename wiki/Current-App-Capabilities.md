...
148. six once-seeded, fully editable starter order templates for common birthday, anniversary,
    ...
    long press on Orders `+` opens native Create Template and Edit Template actions; creation can
    start from blank, an existing order, or another template without creating an order, while edit
