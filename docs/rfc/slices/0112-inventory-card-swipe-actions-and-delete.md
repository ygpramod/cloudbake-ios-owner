...
13. Let the owner swipe horizontally through unused screen space, including gaps between cards, to
    move between adjacent filters without intercepting card-level History, Archive, and Delete swipes.
...
13. Empty-space swipes move between All, Low stock, and Expiring soon in order, while card swipes
    leave the selected filter unchanged.
